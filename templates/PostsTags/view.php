...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Posts Tag'), ['action' => 'edit', $postsTag->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Posts Tag'), ['action' => 'delete', $postsTag->id], ['confirm' => __('Are you sure you want to delete # {0}?', $postsTag->id), 'class' => 'side-nav-item']) ?>
