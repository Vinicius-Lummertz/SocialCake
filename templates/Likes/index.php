 ...
 * @var iterable<\App\Model\Entity\Like> $likes
 */
?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $like->hasValue('post') ? $this->Html->link($like->post->visibility, ['controller' => 'Posts', 'action' => 'view', $like->post->id]) : '' ?></td>
                    <td><?= $like->hasValue('user') ? $this->Html->link($like->user->name, ['controller' => 'Users', 'action' => 'view', $like->user->id]) : '' ?></td>
